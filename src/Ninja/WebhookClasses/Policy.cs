...
namespace net.hempux.ninjawebhook.Models
{
    ...
    public class Policy : IEquatable<Policy>
    {
        ...
        /// </summary>
        /// <value>Parent Policy identifier</value>
        [DataMember(Name = "parentPolicyId", EmitDefaultValue = false)]
        ...
        /// </summary>
        /// <value>Is Default Policy for Node Class</value>
        [DataMember(Name = "nodeClassDefault", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NodeClassDefault: ").Append(NodeClassDefault).Append("\n");
        ...
        public bool Equals(Policy other)
        {
            ...
            return
                ...
                (
                    NodeClassDefault == other.NodeClassDefault ||

                    NodeClassDefault.Equals(other.NodeClassDefault)
                ) &&
                (
                    Tags == other.Tags ||
                    Tags != null &&
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + NodeClassDefault.GetHashCode();
                if (Tags != null)
